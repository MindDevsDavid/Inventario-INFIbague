...
export const getTicketHistory = (id) => api.get(`/tickets/${id}/history`).then((r) => r.data);
export const addTicketNote = (id, data) => api.post(`/tickets/${id}/notes`, data).then((r) => r.data);
